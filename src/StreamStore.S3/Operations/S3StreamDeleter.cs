...
//        public S3StreamDeleter(S3StorageContext ctx, IS3Client client)
//        {
//            this.ctx = ctx;
...
//            do
//            {
//                var response = await client!.ListObjectsAsync(ctx.EventsPath, null, token);
...
//        public static S3StreamDeleter New(S3StorageContext ctx, IS3Client client)
//        {
