...
{
    public class S3StorageTestEnvironment : TestEnvironmentBase
    {
        ...
        internal S3StreamContainer CreateS3StreamContainer()
        {
            return new S3StreamContainer(Path, MockS3ClientFactory.Object);
        }

        public S3StorageTestEnvironment()
        {
