...
using StreamStore.S3.Tests.Storage;
...
namespace StreamStore.S3.Tests.Concurrency.StreamContext
{
    public class Getting_metadata: Scenario<S3StreamContextTestEnvironment>
    {
        ...
        public async Task When_persistent_metadata_exists()
        {
            ...
            {
                Data = Converter.ToByteArray(new[] { new StreamEventMetadata { Id = Generated.Primitives.Id, Revision = Generated.Primitives.Revision, Timestamp = Generated.Primitives.DateTime } }),
