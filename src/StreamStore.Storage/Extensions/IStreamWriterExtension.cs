...
//        public static async Task<IStreamWriter> AppendAsync(this Task<IStreamWriter> writer, IEventRecord record, CancellationToken token = default)
//        {
//            return await FuncExtension.ThrowOriginalExceptionIfOccured(async () => await writer.GetAwaiter().GetResult().AppendAsync(record, CancellationToken.None));
//        }
